...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
	...
	<div class="form-group <?php echo iif( form_error('password') , 'error') ;?>">
		<label class="control-label col-md-2" for="password"><?php echo lang('bf_password'); ?></label>
		<div class="col-md-10">
	...
	<div class="form-group <?php echo iif( form_error('pass_confirm') , 'error') ;?>">
		<label class="control-label col-md-2" for="pass_confirm"><?php echo lang('bf_password_confirm'); ?></label>
		<div class="col-md-10">
