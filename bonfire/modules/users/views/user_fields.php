...
<div class="form-group<?php echo iif(form_error('email'), $errorClass); ?>">
    <label class="control-label col-md-2 col-md-2 required" for="email"><?php echo lang('bf_email'); ?></label>
    <div class="col-md-10">
...
<div class="form-group<?php echo iif(form_error('display_name'), $errorClass); ?>">
    <label class="control-label col-md-2 col-md-2" for="display_name"><?php echo lang('bf_display_name'); ?></label>
    <div class="col-md-10">
...
<div class="form-group<?php echo iif(form_error('username'), $errorClass); ?>">
    <label class="control-label col-md-2 col-md-2 required" for="username"><?php echo lang('bf_username'); ?></label>
    <div class="col-md-10">
...
<div class="form-group<?php echo iif(form_error('password'), $errorClass); ?>">
    <label class="control-label col-md-2 col-md-2<?php echo $registerClass; ?>" for="password"><?php echo lang('bf_password'); ?></label>
    <div class="col-md-10">
...
<div class="form-group<?php echo iif(form_error('pass_confirm'), $errorClass); ?>">
    <label class="control-label col-md-2 col-md-2<?php echo $registerClass; ?>" for="pass_confirm"><?php echo lang('bf_password_confirm'); ?></label>
    <div class="col-md-10">
...
<div class="form-group<?php echo iif(form_error('force_password_reset'), $errorClass); ?>">
	...
	<div class="checkbox">
        <label class="checkbox" for="force_password_reset">
            ...
            <b><?php echo lang('us_force_password_reset'); ?></b>
        </label>
    </div>
    </div>
</div>
...
<div class="form-group<?php echo iif(form_error('language'), $errorClass); ?>">
    <label class="control-label col-md-2 col-md-2 required" for="language"><?php echo lang('bf_language'); ?></label>
    <div class="col-md-10">
...
<div class="form-group<?php echo iif(form_error('timezone'), $errorClass); ?>">
    <label class="control-label col-md-2 col-md-2 required" for="timezones"><?php echo lang('bf_timezone'); ?></label>
    <div class="col-md-10">
