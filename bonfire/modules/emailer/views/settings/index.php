...
<div class="admin-box">
	...
	<fieldset>
		...
		<div class="form-group <?php echo form_error('sender_email') ? 'error' : '' ?>">
			<label class="control-label col-md-2 col-md-2" for="sender_email"><?php echo lang('em_system_email'); ?></label>
			<div class="col-md-10">
		...
		<div class="form-group">
			<label class="control-label col-md-2 col-md-2" for="mailtype"><?php echo lang('em_email_type'); ?></label>
			<div class="col-md-10">
		...
		<div class="form-group <?php echo form_error('protocol') ? 'error' : ''; ?>">
			<label class="control-label col-md-2 col-md-2" for="server_type"><?php echo lang('em_email_server'); ?></label>
			<div class="col-md-10">
	...
	<fieldset>
		...
		<div id="sendmail" class="form-group <?php echo form_error('mailpath') ? 'error' : ''; ?>" style="padding-top: 27px">
			<label  class="control-label col-md-2 col-md-2" for="mailpath">Sendmail <?php echo lang('em_location'); ?></label>
			<div class="col-md-10">
		...
		<div id="smtp" style="padding-top: 27px">
			...
			<div class="form-group <?php echo form_error('smtp_host') ? 'error' : ''; ?>">
				<label class="control-label col-md-2 col-md-2" for="smtp_host">SMTP <?php echo lang('em_server_address'); ?></label>
				<div class="col-md-10">
			...
			<div class="form-group">
				<label class="control-label col-md-2 col-md-2" for="smtp_user">SMTP <?php echo lang('bf_username'); ?></label>
				<div class="col-md-10">
			...
			<div class="form-group">
				<label class="control-label col-md-2 col-md-2" for="smtp_pass">SMTP <?php echo lang('bf_password'); ?></label>
				<div class="col-md-10">
			...
			<div class="form-group">
				<label class="control-label col-md-2 col-md-2" for="smtp_port">SMTP <?php echo lang('em_port'); ?></label>
				<div class="col-md-10">
			...
			<div class="form-group">
				<label class="control-label col-md-2 col-md-2" for="smtp_timeout">SMTP <?php echo lang('em_timeout_secs'); ?></label>
				<div class="col-md-10">
...
<div class="admin-box">
	...
	<?php echo form_open(SITE_AREA .'/settings/emailer/test', array('class' => 'form-horizontal', 'id'=>'test-form')); ?>
		<fieldset>
			...
			<br/>
			<div class="form-group">
				<label class="control-label col-md-2 col-md-2" for="test-email"><?php echo lang('bf_email'); ?></label>
				<div class="col-md-6">
