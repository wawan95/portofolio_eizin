...
<div class="admin-box">
	...
	<fieldset>
		...
		<div class="form-group">
			<label for="log_threshold" class="control-label col-md-2"><?php echo lang('log_the_following'); ?></label>
			<div class="col-md-10">
				<select name="log_threshold" id="log_threshold" style="width: auto; max-width: none;" class="form-control">
