<link rel="stylesheet" type="text/css" href="<?php echo Template::theme_url('css/fontawesome-iconpicker.min.css'); ?>" />
<script src="<?php echo Template::theme_url('js/fontawesome-iconpicker.min.js'); ?>" type="text/javascript"></script>
<?php
...
<p class="intro"><?php echo lang('mb_context_create_intro'); ?></p>
	...
	<?php echo form_open(current_url(), 'class="form-horizontal"'); ?>
		...
		<div class="form-group<?php echo form_has_error('context_name') ? ' error' : ''; ?>">
			<label for="context_name" class="control-label col-md-2 col-md-2"><?php echo lang('mb_context_name'); ?></label>
			<div class="col-md-10">
		...
		<div class="form-group input-group">
			<label for="context_icon" class="control-label col-md-2"><?php echo lang('mb_context_icon'); ?></label>
			<div class="col-md-9">
				<div class="input-group">
				<input type="text" name="context_icon" id="context_icon" class="form-control" />
				<span class="input-group-btn">
					<button type="button" class="btn btn-default" data-toggle="modal" data-target="#iconModal"><i class="fa fa-search"></i></button>
				</span>
				</div>
				<span class="help-inline"><?php
                    echo form_has_error('context_icon') ? form_error('context_icon') . '<br />' : '';
		...
		<div class="form-group">
			<label class="control-label col-md-2 col-md-2" id="roles_label"><?php echo lang('mb_roles_label'); ?></label>
			<div class="col-md-10" aria-labelledby="roles_label" role="group">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Pilih Icon</h4>
      </div>
      <div class="modal-body">
        <div class="panel panel-default">
                <div class="panel-heading">
                    Ketikkan huruf dari icon
                </div>
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="fa col-lg-3">
                            ...
                            <p class="fa fa-arrow-circle-up">nganu</p><br>
