	...
	<div class="col-lg-12 col-md-12">
		<table class="table table-striped">
			...
			<?php foreach ($contexts as $context) : ?>
				<tr>
					<td><?php echo ucfirst($context) ?></td>
					<td>
						<?php echo form_open(SITE_AREA .'/developer/builder/delete_context', 'class="ajax-form"'); ?>
					<input type="hidden" name="context_name" value="<?php echo preg_replace("/[ -]/", "_", $context); ?>">
					<input type="submit" class="btn btn-danger" onclick="return confirm('Really delete this context and all of its permisions?');" value="<?php echo lang('bf_action_delete') ?>" />
					<?php echo form_close(); ?>
					</td>
				</tr>
			<?php endforeach; ?>
