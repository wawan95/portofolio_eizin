...
class Developer extends Admin_Controller {
    ...
    public function create_context()
    {
    	...
    	if (isset($_POST['build']))
    	{
    		...
    		if ($this->form_validation->run() !== false)
    		{
	    		...
	    		$icon		= $this->input->post('context_icon');
		    	...
		    	if (Contexts::create_context($name, $icon, $for_roles, $migrate))
		    	{
    ...
    public function delete_context() 
    {
        ...
        {
                $this->load->library('ui/contexts');
                if (Contexts::delete_context($name))
                {
                    Template::set_message('Context succesfully deleted.', 'success');
                    //redirect(SITE_AREA .'/developer/builder');
                }
                else
                {
                    Template::set_message('Error delete Context: '. Contexts::errors(), 'error');
                }
        }
