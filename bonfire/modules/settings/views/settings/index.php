			...
			<div class="tab-content" style="padding-bottom: 9px; border-bottom: 1px solid #ddd;">
				...
				<div class="tab-pane active" id="main-settings">
					<fieldset>
						...
						<div class="form-group">
							<label class="control-label col-md-2" for="title"><?php echo lang('bf_site_name') ?></label>
							<div class="col-md-10">
						...
						<div class="form-group">
							<label class="control-label col-md-2" for="system_email"><?php echo lang('bf_site_email') ?></label>
							<div class="col-md-4">
						...
						<div class="form-group">
							<label class="control-label col-md-2" for="status"><?php echo lang('bf_site_status') ?></label>
							<div class="col-md-10">
						...
						<div class="form-group">
							<label class="control-label col-md-2" for="list_limit"><?php echo lang('bf_top_number') ?></label>
							<div class="col-md-4">
						...
						<div class="form-group">
							<label class="control-label col-md-2" for="languages"><?php echo lang('bf_language') ?></label>
							<div class="col-md-10">
				...
				<div class="tab-pane" id="security">
					<fieldset>
						...
						<div class="form-group">
							<label class="control-label col-md-2" for="user_activation_method"><?php echo lang('bf_activate_method') ?></label>
							<div class="col-md-10">
						...
						<div class="form-group">
							<label class="control-label col-md-2" for="login_type"><?php echo lang('bf_login_type') ?></label>
							<div class="col-md-10">
						...
						<div class="form-group">
							<label class="control-label col-md-2" id="use_usernames_label"><?php echo lang('bf_use_usernames') ?></label>
							<div class="col-md-10 radio" aria-labelledby="use_usernames_label" role="group">
						...
						<div class="form-group">
							<label class="control-label col-md-2"><?php echo lang('bf_display_name'); ?></label>
						...
						<div class="form-group" id="remember-length" style="<?php if (!$settings['auth.allow_remember']) echo 'display: none'; ?>">
							<label class="control-label col-md-2" for="remember_length"><?php echo lang('bf_remember_time') ?></label>
							<div class="col-md-10">
						...
						<div class="form-group" id="password-strength">
							<label class="control-label col-md-2" for="password_min_length"><?php echo lang('bf_password_strength') ?></label>
							<div class="col-md-10">
						...
						<div class="form-group">
							<label class="control-label col-md-2"><?php echo lang('set_option_password'); ?></label>
							<div class="col-md-10 checkbox">
						...
						<div class="form-group">
							<label for="password_iterations" class="control-label col-md-2"><?php echo lang('set_password_iterations') ?></label>
							<div class="col-md-10">
						...
						<div class="form-group">
							<label class="control-label col-md-2" for="force_pass_reset"><?php echo lang('set_force_reset') ?></label>
							<div class="col-md-10">
					...
					foreach ($extended_settings as $field)
					{
							...
							)
						{
							...
							else
							{
								...
								{
									echo $form_method($field['form_detail']['settings'], set_value($field['name'], isset($settings['ext.' . $field['name']]) ? $settings['ext.' . $field['name']] : ''), $field['label'], 'form-control');
								}
							}
						...
						?>
								<div class="form-group<?php echo $form_error_class; ?>">
									<label class="control-label col-md-2" for="<?php echo $field['name']; ?>"><?php echo $field['label']; ?></label>
									<div class="col-md-10">
