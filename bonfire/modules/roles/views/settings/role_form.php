...
<div class="col-lg-12 col-md-12">
	...
	<fieldset>
		...
		<div class="form-group <?php echo form_has_error('role_name') ? 'error' : ''; ?>">
			<label class="col-md-2" for="role_name"><?php echo lang('role_name'); ?></label>
			<div class="col-md-10">
		...
		<div class="form-group <?php echo form_has_error('description') ? 'error' : ''; ?>" style="vertical-align: top">
			<label class="col-md-2" for="description"><?php echo lang('bf_description'); ?></label>
			<div class="col-md-10">
		...
		<div class="form-group <?php echo form_has_error('login_destination') ? 'error' : ''; ?>">
			<label class="col-md-2" for="login_destination"><?php echo lang('role_login_destination'); ?>?</label>
			<div class="col-md-10">
        ...
        <div class="form-group">
            <label class="col-md-2" for="default_context"><?php echo lang('role_default_context') ?></label>
            <div class="col-md-10">
                <select class="form-control col-md-4" name="default_context" id="default_context">
		...
		<div class="form-group <?php echo form_has_error('default') ? 'error' : ''; ?>">
			<label class="col-md-2" for="default"><?php echo lang('role_default_role')?></label>
		...
		<div class="form-group">
			<label class="col-md-2" id="can_delete_label"><?php echo lang('role_can_delete_role'); ?>?</label>
			<div class="col-md-10 radio" aria-labelledby="can_delete_label" role="group">
