			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge"><?php echo lang('activity_own'); ?></div>
						<div><?php echo lang('activity_own_description'); ?></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge"><?php echo lang('activity_users'); ?></div>
						<div><?php echo lang('activity_users_description'); ?></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge"><?php echo lang('activity_modules'); ?></div>
						<div><?php echo lang('activity_module_description'); ?></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-xs-9 text-right">
						<div class="huge"><?php echo lang('activity_date'); ?></div>
						<div><?php echo lang('activity_date_description'); ?></div>
					</div>
				</div>
			</div>
		</div>
				...
				<td>
					...
					<div class="form-inline">
						<label for="activity_own_select">
							...
							<select class="form-control" name="which" id="activity_own_select">
				...
				<td>
					...
					<div class="form-inline">
						<label for="activity_user_select">
							...
							<select class="form-control" name="which" id="activity_user_select">
				...
				<td>
					...
					<div class="form-inline">
						<label for="activity_module_select">
							...
							<select class="form-control" name="which" id="activity_module_select">
				...
				<td>
					...
					<div class="form-inline">
						<label for="activity_date_select">
							...
							<select class="form-control" name="which" id="activity_date_select">
