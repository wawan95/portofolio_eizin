...
class Contexts
{
	 ...
	 * @var string
	 */
	protected static $parent_class	= 'treeview'; //class <li> menu 1
	 ...
	 * @var string
	 */
	protected static $submenu_class	= 'treeview-menu'; //class <ul> menu 3
		...
		*/
		foreach ($contexts as $context)
		{
			if ( has_permission('Site.'. ucfirst($context) .'.View') == true || permission_exists('Site.'. ucfirst($context) .'.View') == false)
			{
				...
				$nav .= "<li><a href='{$url}' id='{$id}' title='{$title}' data-toggle='dropdown' data-id='{$context}_menu'>";
