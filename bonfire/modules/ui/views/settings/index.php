		...
		<table class="table table-striped table-condensed">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="new_shortcut" class="form-control" value="<?php echo set_value('new_shortcut') ?>" />
					</td>
					<td>
				...
				<?php foreach ($settings as $action => $shortcut): ?>
					<tr>
						...
						<td>
							<input type="text" name="shortcut_<?php echo $action;?>" value="<?php echo set_value("shortcut_$action", $shortcut) ?>" class="form-control"/>
						</td>
						<td>
