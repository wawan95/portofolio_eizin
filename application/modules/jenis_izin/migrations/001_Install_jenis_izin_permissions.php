...
class Migration_Install_jenis_izin_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Jenis_Izin.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jenis_Izin.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jenis_Izin.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jenis_Izin.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
