...
$num_columns	= 2 + 1;
$can_delete	= $this->auth->has_permission('Jenis_Izin.Master.Delete');
$can_edit		= $this->auth->has_permission('Jenis_Izin.Master.Edit');
	    ...
	    <div id="content_table">
			<table id="myTable" class="table table-striped table-bordered">
				...
				<tfoot>
					...
					<tr>
						<td colspan="<?php echo $num_columns; ?>">
							...
							<input type="submit" name="delete" id="delete-me" class="btn btn-danger" value="<?php echo lang('bf_action_delete'); ?>" onclick="return confirm('<?php e(js_escape(lang('jenis_izin_delete_confirm'))); ?>')" />
						</td>
					</tr>
					<?php endif; ?>
				</tfoot>
				...
				<tbody>
					...
					<td><?php e($record->izin_jenis) ?></td><td>
						<?php if ($can_edit) : 
							 echo anchor(SITE_AREA . '/master/jenis_izin/edit/' . $record->id, '<span class="fa fa-edit"></span>'); ?>
						<?php endif; ?>
						<?php if ($can_delete) : ?>
