	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="col-md-10 col-md-offset-2">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('jenis_izin_action_edit'); ?>"  />
				atau
				<?php echo anchor(SITE_AREA .'/master/jenis_izin', lang('jenis_izin_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Jenis_Izin.Master.Delete')) : ?>
				atau
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('jenis_izin_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('jenis_izin_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
