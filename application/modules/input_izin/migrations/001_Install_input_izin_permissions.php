...
class Migration_Install_input_izin_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Input_Izin.Perizinan.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Input_Izin.Perizinan.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Input_Izin.Perizinan.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Input_Izin.Perizinan.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
