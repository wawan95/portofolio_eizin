	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-group <?php echo form_error('izin_nama') ? 'error' : ''; ?>">
				...
				<div class='col-md-10'>
					<?php echo $this->input_izin_model->EditNama('input_izin_izin_nama',$input_izin['izin_nama']);?> 
			...
			<div class="form-group <?php echo form_error('izin_divisi') ? 'error' : ''; ?>">
				...
				<div class='col-md-10'>					
					<?php echo $this->input_izin_model->EditDivisi('input_izin_izin_divisi',$input_izin['izin_divisi']);?> 
			...
			<div class="form-group <?php echo form_error('input_izin_jenis') ? 'error' : ''; ?>">
				...
				<div class='col-md-10'>
				<?php echo form_error('input_izin_jenis'), $this->input_izin_model->EditJenisIzin('input_izin_input_izin_jenis',$input_izin['input_izin_jenis']);?>
			...
			<div class="col-md-10 col-md-offset-2">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('input_izin_action_edit'); ?>"  />
				atau
				<?php echo anchor(SITE_AREA .'/perizinan/input_izin', lang('input_izin_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Input_Izin.Perizinan.Delete')) : ?>
				atau
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('input_izin_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('input_izin_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
