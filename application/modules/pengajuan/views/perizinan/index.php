...
$num_columns	= 8 + 1;
$can_delete	= $this->auth->has_permission('Pengajuan.Perizinan.Delete');
$can_edit		= $this->auth->has_permission('Pengajuan.Perizinan.Edit');
	    ...
	    <div id="content_table">
			<table id="myTable" class="table table-striped table-bordered">
				...
				<tfoot>
					...
					<tr>
						<td colspan="<?php echo $num_columns; ?>">
							...
							<input type="submit" name="delete" id="delete-me" class="btn btn-danger" value="<?php echo lang('bf_action_delete'); ?>" onclick="return confirm('<?php e(js_escape(lang('pengajuan_delete_confirm'))); ?>')" />
						</td>
					</tr>
					<?php endif; ?>
				</tfoot>
				...
				<tbody>
					...
					<td><?php e($this->pengajuan_model->GetList_Jenis_Izin($record->input_izin_jenis)) ?></td>
					...
					<!-- <td> -->
						...
						<!-- <#?php if ($can_edit) : 
							 echo anchor(SITE_AREA . '/perizinan/pengajuan/edit/' . $record->id, '<span class="fa fa-edit"></span>'); ?>
						<#?php endif; ?>
						<#?php if ($can_delete) : ?>
							<a href="#" class="del_this"><i class="fa fa-trash">&nbsp;</i>
						<#?php endif; ?> -->
						<!-- <#?php 
							if($record->izin_status !=0): 	
						 ?> -->
					<!-- <#?php endif  ?> -->
					<!-- </td> -->
					</tr>
