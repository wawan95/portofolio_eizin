...
class Migration_Install_divisi_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Divisi.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Divisi.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Divisi.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Divisi.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
