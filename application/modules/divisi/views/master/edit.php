	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="col-md-10 col-md-offset-2">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('divisi_action_edit'); ?>"  />
				atau
				<?php echo anchor(SITE_AREA .'/master/divisi', lang('divisi_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Divisi.Master.Delete')) : ?>
				atau
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('divisi_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('divisi_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
