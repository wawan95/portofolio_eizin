...
class Migration_Install_konfirmasi_izin_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Konfirmasi_Izin.Perizinan.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Konfirmasi_Izin.Perizinan.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Konfirmasi_Izin.Perizinan.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Konfirmasi_Izin.Perizinan.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
